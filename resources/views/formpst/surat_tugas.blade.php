    ...
    <div class="dropdown-container">
        ...
        <select id="userDropdown" name="user_id" class="form-select" onchange="updateUserInfo(this)">
            ...
            @foreach ($users as $user)
                <option value="{{ $user->id }}" data-nama="{{ $user->nama_lengkap }}" data-ttd="{{ $user->ttd }}">
                    {{ $user->nama_lengkap }}
                </option>
            @endforeach
        </select>        
            ...
            <div class="card-body">
                ...
                <div class="letter-content">
                    ...
                    <div class="assignment">
                        ...
                        <table class="table table-bordered" id="pegawai-table"
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" style="text-align: center; border: 0.5pt solid #000; padding: 0.15cm;">
                    ...
                    <div class="destination">
                        <p>Ke cabang <strong>"{{ $form->cabang_tujuan }}"</strong> untuk <strong>"{{ $form->tujuan }}"</strong></p>
                    </div>
                    ...
                    <div class="signature" style="display: flex; flex-direction: column; align-items: flex-end;">
                        <p>Hormat kami,</p>                    
                        <img id="userSignature" src="" alt="Tanda Tangan" style="width: 150px; height: auto; display: none;">
