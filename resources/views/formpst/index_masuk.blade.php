...
@section('content')
    ...
    <style>
        ...
        /* Ini adalah container utama DataTables, pastikan memiliki border-radius dan overflow hidden */
        .dataTables_wrapper {
            border-radius: 12px;
            overflow: hidden;
            /* Penting! */
            background-color: white;
            /* Tambahkan ini jika ada background putih yang muncul di sudut */
        }
        ...
        .dataTables_wrapper .dataTables_scrollHeadInner {
            ...
            overflow: hidden;
            /* Pastikan juga headernya di-overflow hidden */
        }

        /* Tabel di dalam header DataTables */
        .dataTables_wrapper .dataTables_scrollHeadInner table {
            border-top-left-radius: 12px;
            border-top-right-radius: 12px;
            /* Background-color header */
            background-color: #6a5acd;
            /* Sesuai warna header Anda */
            overflow: hidden;
            /* Penting untuk headernya juga */
        }

        /* Body tabel DataTables */
        .dataTables_wrapper .dataTables_scrollBody {
            border-bottom-left-radius: 12px;
            border-bottom-right-radius: 12px;
            overflow: hidden;
            /* Penting untuk body-nya juga */
        }
        ...
        .custom-table {
            ...
            border-spacing: 0;
            width: 100% !important;
            /* Penting untuk DataTables */
        }

        .custom-table thead tr {
            /* background-color: #6a5acd; <- Ini bisa dihilangkan jika sudah diatur di .dataTables_scrollHeadInner table */
            color: white;
        }
        ...
        /* Sudut atas kiri dan kanan pada th pertama dan terakhir di thead */
        /* Ini tetap penting untuk visual TH, meskipun overflow pada parent sudah diatur */
        ...
        /* Border untuk sel-sel body agar terlihat terpisah */
        .custom-table tbody td {
        ...
        .custom-table tbody tr:last-child td {
            border-bottom: none;
            /* Hapus border bawah pada baris terakhir */
        }

        /* Sudut bawah kiri dan kanan pada baris terakhir */
        ...
        /* -- Export Buttons Styling (DataTables) -- */
        div.dt-buttons {
            display: inline-flex;
