                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="no_surat"
                                        id="noSurat" value="{{ $nomorSurat }}" readonly required style="width: 100%;">
                                </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            namaPegawaiInputs.forEach((select, index) => {
                ...
                input.type = 'hidden';
                input.name = namaPegawaiNama[$ {
                    index
                }]; // Pastikan nama sesuai dengan backend
                input.value = nama;
    ...
    <style>
        ...
        .card {
            ...
            /* background-image: url('{{ asset('dist/img/arnon.png') }}');
                                background-size: 30%; Mengatur ukuran gambar menjadi 30% dari ukuran elemen
                                background-position: 50% 30%; Memastikan gambar tetap di tengah
